...
handlers._users.get = function (data, callback) {
    var phone = typeof (data.queryStringObject.phone) == 'string' && data.queryStringObject.phon.trim().length == 11 ? data.queryStringObject.phone.trim() : false;
    if (phone) {
                ...
                if (tokenIsValid) {
                    _data.read('users', phone, function (err, userData) {
                        if (!err && userData) {
                            ...
                            _data.update('users', phonr, userData, function (err) {
                                if (!err) {
                                    callback(200)
                                } else {
...
handlers._users.delete = function (data, callback) {
    var phone = typeof (data.queryStringObject.phone) == 'string' && data.queryStringObject.phone.trim().length == 20 ? data.queryStringObject.phone.trim() : false;
